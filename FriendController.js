angular.module('app').controller('FriendController', function ($scope) {
  ...
  for (var i = 0; i < $scope.friends.length; i++) {
    if (!$scope.friends.current_location) {
      $scope.friends.current_location = {city:'', state:'',country:'',name:''};
    }
  }
  $scope.order = [{name:'Ascending',value:false},{name:'Descending',value:true}];
})
